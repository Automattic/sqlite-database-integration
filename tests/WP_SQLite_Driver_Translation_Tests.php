	...
	public function testAlterTableAddColumn(): void {
		...
		$this->assertQuery(
			array(
				...
				'CREATE TABLE "<tmp-table>" ( "id" INTEGER, "a" INTEGER )',
	...
	public function testAlterTableAddColumnWithNotNull(): void {
		...
		$this->assertQuery(
			array(
				'PRAGMA foreign_keys',
				'PRAGMA foreign_keys = OFF',
				'CREATE TABLE "<tmp-table>" ( "id" INTEGER, "a" INTEGER NOT NULL )',
				'INSERT INTO "<tmp-table>" ("rowid", "id") SELECT "rowid", "id" FROM "t"',
				'DROP TABLE "t"',
				'ALTER TABLE "<tmp-table>" RENAME TO "t"',
				'PRAGMA foreign_key_check',
	...
	public function testAlterTableAddColumnWithDefault(): void {
		...
		$this->assertQuery(
			array(
				'PRAGMA foreign_keys',
				'PRAGMA foreign_keys = OFF',
				'CREATE TABLE "<tmp-table>" ( "id" INTEGER, "a" INTEGER DEFAULT \'0\' )',
				'INSERT INTO "<tmp-table>" ("rowid", "id") SELECT "rowid", "id" FROM "t"',
				'DROP TABLE "t"',
				'ALTER TABLE "<tmp-table>" RENAME TO "t"',
				'PRAGMA foreign_key_check',
	...
	public function testAlterTableAddColumnWithNotNullAndDefault(): void {
		...
		$this->assertQuery(
			array(
				'PRAGMA foreign_keys',
				'PRAGMA foreign_keys = OFF',
				'CREATE TABLE "<tmp-table>" ( "id" INTEGER, "a" INTEGER NOT NULL DEFAULT \'0\' )',
				'INSERT INTO "<tmp-table>" ("rowid", "id") SELECT "rowid", "id" FROM "t"',
				'DROP TABLE "t"',
				'ALTER TABLE "<tmp-table>" RENAME TO "t"',
				'PRAGMA foreign_key_check',
	...
	public function testAlterTableAddMultipleColumns(): void {
		...
		$this->assertQuery(
			array(
				'PRAGMA foreign_keys',
				'PRAGMA foreign_keys = OFF',
				'CREATE TABLE "<tmp-table>" ( "id" INTEGER, "a" INTEGER, "b" TEXT COLLATE NOCASE, "c" INTEGER )',
				'INSERT INTO "<tmp-table>" ("rowid", "id") SELECT "rowid", "id" FROM "t"',
				'DROP TABLE "t"',
				'ALTER TABLE "<tmp-table>" RENAME TO "t"',
				'PRAGMA foreign_key_check',
	...
	public function testAlterTableDropColumn(): void {
		...
		$this->assertQuery(
			array(
				'PRAGMA foreign_keys',
				'PRAGMA foreign_keys = OFF',
				'CREATE TABLE "<tmp-table>" ( "id" INTEGER )',
				'INSERT INTO "<tmp-table>" ("rowid", "id") SELECT "rowid", "id" FROM "t"',
				'DROP TABLE "t"',
				'ALTER TABLE "<tmp-table>" RENAME TO "t"',
				'PRAGMA foreign_key_check',
	...
	public function testAlterTableAddAndDropColumns(): void {
		...
		$this->assertQuery(
			array(
				'PRAGMA foreign_keys',
				'PRAGMA foreign_keys = OFF',
				'CREATE TABLE "<tmp-table>" ( "b" INTEGER )',
	...
	public function testAlterTableDropAndAddSingleColumn(): void {
		...
		$this->assertQuery(
			array(
				'PRAGMA foreign_keys',
				'PRAGMA foreign_keys = OFF',
				'CREATE TABLE "<tmp-table>" ( "a" INTEGER )',
				'INSERT INTO "<tmp-table>" ("rowid") SELECT "rowid" FROM "t"',
				'DROP TABLE "t"',
				'ALTER TABLE "<tmp-table>" RENAME TO "t"',
				'PRAGMA foreign_key_check',
